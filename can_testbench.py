...
class CanTabManager():
    ...
    """
    def __init__(self, config: CanConfig, channel: str, bus: pycan.bus, dbcDb):
        self.config = config
        self.channel = channel
    ...
    def initTabs(self, tabWidget: QTabWidget):
        ...
        self.setupMessageLogTab('LOG ' + self.channel, tabWidget)
    ...
    def connectCan(self):                                                                                   
        ...
        if channel:
            ...
            try:
                ...
                self.errorDialog(error)
                return
            canManager = CanTabManager(self.config, channel, bus, self.dbcDb)
        else:
